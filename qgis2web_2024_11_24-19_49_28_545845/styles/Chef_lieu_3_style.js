...
var style_Chef_lieu_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_Chef_lieu_3(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
        ...
        image: new ol.style.Circle({radius: 6.8 + size,
            stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(255,109,238,1.0)'})}),
        ...
        var style = rules_Chef_lieu_3(feature, value);
        ;
